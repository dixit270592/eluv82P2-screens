...
$Handoff = if (Test-Path "E:\Element-P2P\Element-P2P-Handoff") {
    "E:\Element-P2P\Element-P2P-Handoff"
} else {
    Join-Path (Split-Path -Parent (Split-Path -Parent $MyInvocation.MyCommand.Path)) "Element-P2P-Handoff"
}
